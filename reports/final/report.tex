...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=\textwidth,height=7.0cm,keepaspectratio]{historique-coups}
\end{figure}
...
PARLER BRIEVEMENT DU COMPOSITE PATTERN (CAR ARCHI ?) ET EXPLIQUER STANDARD ET ENDGAME.
...
\begin{itemize}
    ...
    \item \subsection{Monte Carlo Tree Search}
    ...
    nombre de simulations effectuées, et d la profondeur moyenne. En espace, COMPLETER PAR LA COMPLEXITE CORRECTE.\\
