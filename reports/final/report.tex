...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|}
      ...
      \hline
      \texttt{MaterialHeuristic} & 92.36\\
      \texttt{MobilityHeuristic} & 5.49\\
      \texttt{BadPawnHeuristic} & 0.00\\
      \texttt{PawnChainHeuristic} & 0.00\\
      \texttt{KingSafetyHeuristic} & 3.41\\
      \texttt{DevelopmentHeuristic} & 48.35\\
      \texttt{CheckHeuristic} & 0.00 \\
      \texttt{SpaceHeuristic} & 9.74 \\
      \texttt{GamePhaseHeuristic} & 10\,000 \\
      \hline
    \end{tabular}
  \end{table}
...
La totalité des \textit{System.out/err} ont été remplacé par des appels à des loggers via les fonctions \textit{print} et \textit{error} dans notre class \textit{Logging}.
...
sourtout lors des fins de parties. On peut donc estimer que notre IA depasse les 1400 Elo sur des profondeurs supérieures à 4.
