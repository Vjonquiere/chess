...
Cette interface nous offre également l'opportunité de créer différentes implémentations, avec des Bitboard (notre class \textit{BitboardRepresentation}), des tableaux 2D ou d'autres structures de données.
...
Enfin, concernant le temps moyen pour jouer un coup, les versions parallèles sont plus rapides que les versions séquentielles, avec un gain de 2.2x pour \texttt{ALPHA\_BETA\_PARALLEL} et de 3.1x pour \texttt{ALPHA\_BETA\_ID\_PARALLEL}. Ces résultats montrent que la parallélisation permet d'atteindre des performances nettement supérieures, même si le coût d'exploration est plus élevé.
...
Le plus interresant à été de pouvoir jouer des parties complètes contre d'autres programmes complètement paramétrables et d'éviter par exemple le dertiminisme
