...
Le cœur du projet se situe dans les classes \textit{Game} et \textit{BitboardRepresenation}.
...
\begin{figure}[h]
    ...
    \label{umlController}
\end{figure}
La figure \ref{umlController} est simplifiée, une seule commande concrète apparait, dans notre projet,
nous en avons implémenté une dizaine, en implémentant l'interface \textit{Command}.
\FloatBarrier
