...
\lstdefinelanguage{pseudocode}{
  morekeywords={function, return, if, true, false},
  sensitive=true,
  morecomment=[l]{//},
  morestring=[b]",
}
...
Puisque le stockage du plateau de jeu se fait à l'aide d'un vecteur de 12 bitboards, nous avons rapidement eu besoin de lier chacune d'elle à un type de pièce pour chaque couleur.
...
Le Controller, ou plutôt le Bag Of Commands agit comme interprète entre la Vue et le Model, va recevoir des commandes de la part de la Vue capables d'appeler les fonctions correspondantes dans le Model.
...
\begin{itemize}
    ...
    \item \textbf{Board} : Contient le plateau de jeu, ses représentations ainsi que des classes utilitaires comme le cache,
...
cette limite car elle permet d'obtenir de meilleurs coups. Mais la profondeur de recherche est également le facteur limitant, passer d'une profondeur p à une profondeur p+1 est exponentiel car le facteur
