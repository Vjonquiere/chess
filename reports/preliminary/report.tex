...
\begin{needbox}[F42: Fichier de configuration]
    \begin{subneedbox}[F42.1: Utiliser le format INI]
        Les options du jeu doivent être sauvegardées au format \textit{INI}.

        \textbf{Test:} Tester avec plusieurs fichiers (certains mal former) et vérifier 
    ...
    \begin{subneedbox}[F42.3: fichier d'option non valide]
        Si un fichier ne correspond par au fichier \textit{INI} ou contient une 
