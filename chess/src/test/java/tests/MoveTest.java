...
public class MoveTest {
  ...
  public void testEquals_sameMove() {
    Position source1 = new Position(1, 4); // "e2"
    Position dest1 = new Position(3, 4); // "e4"
    Move move1 = new Move(source1, dest1, null, true);

    Position source2 = new Position(1, 4); // "e2"
    Position dest2 = new Position(3, 4); // "e4"
  ...
  public void testEquals_differentMove() {
    ...
    Position source3 = new Position(0, 1); // "b1"
    Position dest3 = new Position(2, 1); // "b3"
  ...
  public void testFromString_validMove() {
    ...
    Position expectedSource = new Position(1, 4); // "e2"
    Position expectedDest = new Position(3, 4); // "e4"
  ...
  public void testToString() {
    Position source = new Position(1, 4); // "e2"
    Position dest = new Position(3, 4); // "e4"
  ...
  public void testStringToPosition() {
    ...
    Position expected = new Position(3, 4); // "e4" corresponds to (3, 4)
