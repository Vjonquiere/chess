...
public class ContestMode implements View {
  private boolean running = false;
  private final Map<String, CommandEntry> commands = new HashMap<>();
  private static final Logger LOGGER = Logger.getLogger(ContestMode.class.getName());
    ...
    try {
      switch (event) {
        ...
        case MOVE_PLAYED:
          ...
          System.out.println(Game.getInstance().getHistory().toUniString());
          runtime.exit(0);
          break;
        case WIN_WHITE:
